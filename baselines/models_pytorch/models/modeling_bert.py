...
class BertForWordLevelArgumentLabel(BertPreTrainedModel):
...
class BertForWordLevelPredicateSense(BertPreTrainedModel):
...
class BertForEnd2EndSrl(BertPreTrainedModel):
